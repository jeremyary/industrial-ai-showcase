...
from vla_training.constants import (
    GPU_LIMIT,
    MLFLOW_TRACKING_URI,
...
def vla_register_model_op(
    ...
    return dsl.ContainerSpec(
        ...
        args=[
            ...
            'echo "Start time: $(date -u)"\n'
            "\n"
            "python -m vla_training.register_model \\\n"
            '  --name "${MODEL_NAME}" \\\n'
            '  --uri "${MODEL_URI}" \\\n'
